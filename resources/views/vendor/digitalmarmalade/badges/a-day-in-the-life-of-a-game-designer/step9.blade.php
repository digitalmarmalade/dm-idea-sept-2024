...
.range-labels .range-label:first-child { float:left; }
    ...
    <body>
        ...
        <p>How difficult should the game be? Do you want people to get to the end or make it virtually impossible? This is a key component to addictiveness – make it too hard and they will get frustrated and quit, make it too easy and the game no longer holds interest.</p>
        <p>We are going to have 3 levels in our game, how should these vary? More questions each time, different categories? How many right answers should we include (accuracy)? </p>
        <p>Take your time to play around with this, making sure you balance the game challenge with how long it lasts.</p>
...
--}}
        ...
        <script>@include('_inliner', array('file' => '/vendor/digitalmarmalade/badges/'.$url['slug'].'/js/step-9.js', 'min' => false))</script>
