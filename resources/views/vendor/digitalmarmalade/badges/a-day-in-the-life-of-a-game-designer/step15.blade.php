...
.range-labels .range-label:first-child { float:left; }
    ...
    <body>
        ...
        <h3 class="feature-heading">Game Levels</h3>
        <p>
            Game levels need to be achievable or we lose interest, so you need to balance levels and complexity. It doesn’t necessarily need to have an end to the levels – think of Candy Crush which has over 2,000 levels and counting!
        </p>
        <p>
            Your choices are how many categories per level (up to three), number of questions per level (up to twenty) and how many right answers you would expect in each level (accuracy). You need to balance challenge, length of levels and game, competition, progress and desire to play again.
        </p>
...
--}}
        ...
        <script>
            ...
            oBadges.setSlugAndStep('{{$url['slug']}}', 15);
            oBadges.redirectIfPreviousStepNotCompleted(14, '{{$links['last']}}');
        ...
        <script>@include('_inliner', array('file' => '/vendor/digitalmarmalade/badges/'.$url['slug'].'/js/step-15.js', 'min' => false))</script>
