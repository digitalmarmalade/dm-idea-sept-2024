...
@section('page')
    ...
    <body>
        ...
        <p>Now is your final chance to improve your game!</p>
        ...
        <div class="select-colours clearfix">
            ...
            <ul class="advice-list">
                <li class="negative">
                    Don't use complementary colours as they are too high contrast, analogous probably works best.
                </li>                
            </ul>
        ...
        <script>
            ...
            oBadges.setSlugAndStep('{{$url['slug']}}', 17);
            oBadges.redirectIfPreviousStepNotCompleted(16, '{{$links['last']}}');
        </script>
        <script>@include('_inliner', array('file' => '/vendor/digitalmarmalade/badges/'.$url['slug'].'/js/all.js', 'min' => false))</script>
        <script>@include('_inliner', array('file' => '/vendor/digitalmarmalade/badges/'.$url['slug'].'/js/step-17.js', 'min' => false))</script>
