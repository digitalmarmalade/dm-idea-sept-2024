...
(function () {
    ...
    oBadges.checkForDuplicateGameCategories = function () {
        if (oBadges.areThereDuplicateGameCategories() === true) {
            $('ul.advice-list li[data-type="cats-same"]').addClass('show');
        } else {
            $('ul.advice-list li[data-type="cats-same"]').removeClass('show');
        }
    }

    oBadges.areThereDuplicateGameCategories = function () {
        var c1 = $('#category1Label').val(),
            c2 = $('#category2Label').val(),
            c3 = $('#category3Label').val();
    ...
    $('#categoryNames select').change(function(){
        ...
        oBadges.checkForDuplicateGameCategories();
