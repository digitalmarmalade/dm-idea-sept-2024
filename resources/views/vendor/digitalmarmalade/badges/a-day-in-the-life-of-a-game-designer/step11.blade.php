...
@section('page')
    ...
    <body>
        ...
        <p>You'll now have the chance to adjust your settings and improve your version of Total Swipeout. As we go, let's dig a little deeper into some of the elements that make a great game.</p>

        <div class="select-colours clearfix">
            
            <h3>APPEARANCE (GAME AESTHETICS)</h3>
            <p style="margin:0 10px;">The appearance of your game needs to match audience needs and expectations. Expectations change as technology develops: for some types of games it is critically important how they look. 
            </p>
            
            <div class="game-genre-container">
                <h4>Action & Adventure Games</h4>
                <p>
                    Game players expect outstanding appearance from adventure games. A modern example is the action shooter <b>Star Wars Battlefront</b>. Comparing this with an action adventure game from the past, <b>Tomb Raider</b> (1996), you can see how expectations have changed.
                </p>    
                
                <div class="screenshot-container screenshot-container--margin-bottom">
                    <figure>
                        <img src="/badge-assets/{{$url['slug']}}/_global/img/screenshot-battlefront.jpg" alt="Star Wars Battlefront" />
                    </figure>
                    <figure>
                        <img src="/badge-assets/{{$url['slug']}}/_global/img/screenshot-tomb-raider.jpg" alt="Tomb Raider" />
                    </figure>
                </div>
                
                <p>
                    <b>E.T. the Extra-Terrestrial</b> (1982) on the Atari 2600 is an example of an adventure game that never met audience expectations, and many think had a negative effect on gaming generally. This shows just how important expectations can be.
                </p>
                <div class="screenshot-container">
                    <figure>
                        <img src="/badge-assets/{{$url['slug']}}/_global/img/screenshot-et.jpg" alt="ET" />
                    </figure>
                </div>
            </div>
            
            <div class="game-genre-container">
                <h4>Physics Puzzle Games</h4>
                <p>
                    For physics puzzle games, such as <b>Angry Birds</b>, the appearance isn't as important. Making the gameplay objects interesting, challenging and fun is far more important. Audience expectations don't change as quickly, as you can see by looking at <b>Worms</b> (1995).
                </p>    
                <div class="screenshot-container">
                    <figure>
                    ...
                    <figure>
                        <img src="/badge-assets/{{$url['slug']}}/_global/img/screenshot-worms.jpg" alt="Worms" />
                    </figure>
                </div>
            </div>

            <div class="game-genre-container">
                <h4>Matching Puzzle Games</h4>
                <p>
                    For matching puzzle games, appearance is even less important, but gameplay and challenge are key. In games like <b>Tetris</b> or <b>Candy Crush</b>, objects need to be nice, but gameplay makes them interesting. 
                </p>    
                <p>
                ...
                <div class="screenshot-container">
                    <figure>
                        <img src="/badge-assets/{{$url['slug']}}/_global/img/screenshot-tetris.jpg" alt="Tetris" />
                    </figure>
                    <figure>
                        <img src="/badge-assets/{{$url['slug']}}/_global/img/screenshot-candy-crush.jpg" alt="Candy Crush" />
                     </figure>
                </div>
            </div>
            

				<p>Think about how the test version of your game worked, are there any changes you would like to make to the game appearance?</p>
        ...
        <script>
            ...
            oBadges.redirectIfPreviousStepNotCompleted(10, '{{$links['last']}}');
        </script>
        <script>@include('_inliner', array('file' => '/vendor/digitalmarmalade/badges/'.$url['slug'].'/js/all.js', 'min' => false))</script>
        <script>@include('_inliner', array('file' => '/vendor/digitalmarmalade/badges/'.$url['slug'].'/js/step-11.js', 'min' => false))</script>
