...
@section('page')
    ...
    <body>
        ...
        <p>One final chance to change your categories!</p>
        ...
        <fieldset id="categoryNames">
            ...
            <ul class="advice-list">
                <li class="negative" data-type="cats-same">
                    You have categories that are the same!
                </li>     
                <li class="negative" data-type="cats-similar">
                    Range of categories makes it harder, similar categories is easier and likely to be less interesting
                </li>                
            </ul>
        ...
        <script>
            ...
            oBadges.setSlugAndStep('{{$url['slug']}}', 18);
            oBadges.redirectIfPreviousStepNotCompleted(17, '{{$links['last']}}');
        </script>
        <script>@include('_inliner', array('file' => '/vendor/digitalmarmalade/badges/'.$url['slug'].'/js/all.js', 'min' => false))</script>
        <script>@include('_inliner', array('file' => '/vendor/digitalmarmalade/badges/'.$url['slug'].'/js/step-18.js', 'min' => false))</script>
