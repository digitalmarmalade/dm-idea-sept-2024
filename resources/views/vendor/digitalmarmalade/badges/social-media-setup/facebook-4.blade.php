...
<main>
    <section class="only-section last-section">
        <div class="section-title ">
            <p>Facebook</p>
        </div>
        <div class="holder">
            <p>Select below <b>the only way</b> you cannot add a friend to Facebook:</p>
            <ul class="task">
                <li data-aos="fade-in" data-aos-delay="100">
                    <a class="btn btn-primary" href="#"><span>By searching for friends in the &ldquo;Find Friends&rdquo; section</span></a>
                </li>
                <li data-aos="fade-in" data-aos-delay="200">
                    <a class="btn btn-primary" href="#"><span>By uploading contacts from your phone or other accounts</span></a>
                </li>
                <li data-aos="fade-in" data-aos-delay="300">
                    <a class="btn btn-primary" href="#" data-value="true" ><span>By texting your friend using your mobile phone</span></a>
                </li>
                <li data-aos="fade-in" data-aos-delay="400">
                    <a class="btn btn-primary" href="#"><span>By using the &ldquo;People You May Know&rdquo; feature</span></a>
                </li>
