...
<main>
    <section class="section-task">
        ...
        <div class="holder">
            <p>Are the statements in relation to LinkedIn below true <b>or</b> false?</p>
            <ul class="task-true-false">
                <li>
                    <p>You can customise your public profile settings to set limits on how much of your profile information can be displayed.</p>
                    <span class="true-false-box" id="box-1">
                        <span data-value="1"><a href="#" >True</a></span> <!-- correct answer -->
                        <span data-value="2"><a href="#" >False</a></span>
                    </span>
                </li>
                <li>
                    <p>After you change or disable your public profile, it is  immediately  added to or removed from search engine results.</p>
                    <span class="true-false-box" id="box-2">
                        <span data-value="3"><a href="#" >True</a></span>
                        <span data-value="4"><a href="#" >False</a></span><!-- correct answer -->
                    </span>
                </li>
                <li>
                    <p>Your LinkedIn profile will always have a web address (URL) even if your profile is not set as a public.</p>
                    <span class="true-false-box" id="box-3">
                ...
                <li>
                    <p>Your custom URL can have unlimited numbers and types of characters.</p>
                    <span class="true-false-box" id="box-4">
...
<script src="/badge-assets/{{$url['slug']}}/_global/js/step-37.js"></script>
@endsection
