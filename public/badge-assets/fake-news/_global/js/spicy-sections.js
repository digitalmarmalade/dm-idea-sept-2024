...
(function() {
  ...
  style.innerHTML = `
    :where(spicy-sections > [affordance*="collapse"])::before { 
      ...
      background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' width='10px' height='10px' viewBox='0 0 270 240' enable-background='new 0 0 270 240' xml:space='preserve'%3e%3cpolygon fill='orange' points='5,235 135,10 265,235 '/%3e%3c/svg%3e ");
