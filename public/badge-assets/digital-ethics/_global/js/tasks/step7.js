...
if ( questionNum !== 0 && questionNum < questionTotal) {
    $('#sentence1').hide();
    $('#sentence2').show();
...
function checkAnswer1_1_3() {
    ...
    if (i === 2 && question1_1_3[0].checked && question1_1_3[3].checked) {
    ...
    } else if ((i === 2 && !question1_1_3[0].checked) && (i === 2 && !question1_1_3[3].checked)) {
        $('#jsFeedbackFail1-1-3-3').show();
    } else if ((i === 2 && question1_1_3[0].checked) || (i === 2 && !question1_1_3[3].checked)) {
        $('#jsFeedbackFail1-1-3-4').show();
    } else if ((i === 2 && !question1_1_3[0].checked) || (i === 2 && question1_1_3[3].checked)) {
        $('#jsFeedbackFail1-1-3-4').show();
    }
...
function checkAnswer2_1_2() {
    ...
    } else if ( (question2_1_2[1].checked && question2_1_2[3].checked && i===3) ||
        (question2_1_2[1].checked && question2_1_2[3].checked && i===4) ||
        (question2_1_2[1].checked && question2_1_2[3].checked && i===3) ||
        (question2_1_2[1].checked && question2_1_2[3].checked && i===4) ){
        $('#jsFeedbackFail2-1-2-3').show();
    } else if ( (question2_1_2[1].checked && !question2_1_2[3].checked && i===2) ||
        (!question2_1_2[1].checked && question2_1_2[3].checked && i===2) ){
        $('#jsFeedbackFail2-1-2-4').show();
    } else {
...
function checkAnswer2_2_2() {
    ...
    if (question2_2_2[2].checked &&
        ...
        questionNum++;
    } else if (question2_2_2[2].checked && question2_2_2[3].checked && i===3) {
        $('#jsFeedbackFail2-2-2-3').show();
        questionNum++;
    } else if ((question2_2_2[2].checked && !question2_2_2[3].checked && i===2) ||
        (!question2_2_2[2].checked && question2_2_2[3].checked && i===2)) {
        $('#jsFeedbackFail2-2-2-4').show();
        questionNum++;
    } else if  (i===1){
...
function tryAgain2_1_2() {
    ...
    $('#jsFeedbackFail2-1-2-3').hide();
    $('#jsFeedbackFail2-1-2-4').hide();
...
function tryAgain2_2_2() {
    ...
    $('#jsFeedbackFail2-2-2-3').hide();
    $('#jsFeedbackFail2-2-2-4').hide();
