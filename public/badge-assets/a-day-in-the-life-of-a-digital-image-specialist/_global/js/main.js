...
$( ".mysterious-list li" ).click(function() {
    ...
    validateMysteriousCheckboxes();


    
});

$( ".relaxed-list li" ).click(function() {
    ...
    validateRelaxedCheckboxes();


    
});

$( ".happy-list li" ).click(function() {
