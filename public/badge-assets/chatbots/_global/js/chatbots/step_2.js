    ...
    let sideChatBotMessages = [
      ...
      },
      {
        ...
        message: `
            <div class="chatbot__middle--entry chatbot__middle--entry-left">
                ${chatBotIcon}
                <p>To complete this section, you will need to read and click on the NLP features to see examples, 
                then you will need to select the correct <strong>feature name</strong> by reading the <strong>feature description</strong> and deducing the correct match.<br/><br/>
                Thank you.</p>
            </div>`,
      },
    ];
