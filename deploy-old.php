...
set('bin/php', 'docker-compose -f ~/docker/aws-qa/docker-compose.yml exec -T php71 php');
...
set('repository', 'git@gitlab-idea-repo:idea-award/idea-badges/digital-marmalade.git');
